defmodule HelloWorldNTimesTest do
  ...
  test "test that returns 'Hello World' 1 time" do
    assert HelloWorldNTimes.greet(1) == "Hello World"
  end

  test "test that returns 'Hello World' 2 time" do
    assert HelloWorldNTimes.greet(2) == "Hello World\nHello World"
  end

  test "test that returns 'Hello World' 10 time" do
    expected =
"Hello World
Hello World
Hello World
...
Hello World"
  ...
  test "test the return to zero" do
    assert HelloWorldNTimes.greet(0) == ""
  end

  test "test the return to negative numbers" do
    assert HelloWorldNTimes.greet(-1) == :error
  end

  test "test invalid nil value" do
    assert HelloWorldNTimes.greet(nil) == :error
  end

  test "test invalid float value" do
